...
scl_df.to_excel('Dis1_no_links_scl_0909.xlsx',header = True,index = False)
print('get excel file: Dis1_no_links_scl_0909.xlsx')
print(len(scl_df[scl_df.simple_connectivity_loss < 0]))



city_two_layer_network_edges_no_links_scl = pd.merge(scl_df,city_two_layer_network_edges,left_on='removed_edge_id',right_on='id',how='inner')
city_two_layer_network_edges_no_links_scl.to_excel('Dis1_city_two_layer_network_edges_no_links_scl_0909.xlsx',header = True,index = False)
print('get excel file: Dis1_city_two_layer_network_edges_no_links_scl_0909.xlsx')
...
# In[ ]:
# scl_df = scl_df.sort_values(by='simple_connectivity_loss')
# scl_df.to_excel('Dis1_no_links_scl_0906.xlsx',header = True,index = False)
# print('get excel file: Dis1_no_links_scl_0906.xlsx')
# print(len(scl_df[scl_df.simple_connectivity_loss < 0]))



# city_two_layer_network_edges_no_links_scl = pd.merge(scl_df,city_two_layer_network_edges,left_on='removed_edge_id',right_on='id',how='inner')
# city_two_layer_network_edges_no_links_scl.to_excel('Dis1_city_two_layer_network_edges_no_links_scl_0906.xlsx',header = True,index = False)
# print('get excel file: Dis1_city_two_layer_network_edges_no_links_scl_0906.xlsx')
