...
scl_df.to_excel('Dis1_scl_0909.xlsx',header = True,index = False)
print('get excel file: Dis1_scl_0909.xlsx')
...
city_two_layer_network_edges_scl.to_excel('Dis1_city_two_layer_network_edges_scl_0909.xlsx',header = True,index = False)
print('get excel file: Dis1_city_two_layer_network_edges_scl_0909.xlsx')
