...
# connect_edges_sub_to_tram['weights'] = 100000000
...
# connect_edges_sub_to_tram['wcl_weights'] = 1400
# connect_edges_sub_to_tram['wcl_weights'] = 1500
# connect_edges_sub_to_tram['wcl_weights'] = 2000
...
# ### 0909 2000 1000 1000 -- all edges

# In[ ]:


dwcl_df.to_excel('Dis1_dwcl_0909.xlsx',header = True,index = False)
print('get excel file: Dis1_dwcl_0909.xlsx')
print(len(dwcl_df[dwcl_df.DWCL_weights < 0]))


city_two_layer_network_edges_dwcl = pd.merge(dwcl_df,city_two_layer_network_edges,left_on='removed_edge_id',right_on='id',how='inner')
city_two_layer_network_edges_dwcl.to_excel('Dis1_city_two_layer_network_edges_dwcl_0909.xlsx',header = True,index = False)
print('get excel file: Dis1_city_two_layer_network_edges_dwcl_0909.xlsx')
...
# dwcl_df  ## 4000; 1�virtual links distance;  600,600
# dwcl_df.to_excel('Dis1_dwcl_0906.xlsx',header = True,index = False)
# print('get excel file: Dis1_dwcl_0906.xlsx')
# print(len(dwcl_df[dwcl_df.DWCL_weights < 0]))


# city_two_layer_network_edges_dwcl = pd.merge(dwcl_df,city_two_layer_network_edges,left_on='removed_edge_id',right_on='id',how='inner')
# city_two_layer_network_edges_dwcl.to_excel('Dis1_city_two_layer_network_edges_dwcl_0906.xlsx',header = True,index = False)
# print('get excel file: Dis1_city_two_layer_network_edges_dwcl_0906.xlsx')
