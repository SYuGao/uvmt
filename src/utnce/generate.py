...
def check_metro_routes(osm_path, city='Rotterdam'):
    """
...
def recheck_metro_routes(city_sub_stations, replacement_dict, city_sub_routes):
    """
...
def metro(osm_path, city_sub_routes, city='Rotterdam'):
    """
    ...
    city_sub_order_route_dict = order_stations_inline(city_sub_line_dict, city_all_sub_stations_name,
                                                     city_sub_stations, city_sub_start_station_name_dict)
    ...
    for line in city_sub_order_id_pairs.keys():
        ...
        duplicate_row_count[line], city_sub_shortest_path_edges[line], city_sub_edges[line] = 
                                      edges_with_count_weight(city_sub_shortest_path_pairs[line], edges)
...
def check_tram_routes(osm_path, city='Rotterdam'):
...
def recheck_tram_routes(city_sub_stations, replacement_dict, city_sub_routes):
